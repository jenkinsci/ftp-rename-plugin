 ...
 * and a new {@link FtpRenameBuilder} is created. The created
...
public class FtpRenameBuilder extends Builder implements SimpleBuildStep {
    ...
    public FtpRenameBuilder(String ftpServer, int ftpPort, String ftpUser, Secret ftpPassword, String ftpPath) {
    ...
    /**
     * Descriptor for {@link FtpRenameBuilder}. Used as a singleton.
     * The class is marked as public so that it can be accessed from views.
     *
     * <p>
     * See <tt>src/main/resources/hudson/plugins/hello_world/FtpRenameBuilder/*.jelly</tt>
